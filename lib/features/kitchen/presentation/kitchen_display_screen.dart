...
final kitchenItemsProvider = StreamProvider.autoDispose<List<Map<String, dynamic>>>((ref) {
...
class KitchenDisplayScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final itemsAsync = ref.watch(kitchenItemsProvider);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Items
            ...items.map((item) => _KitchenItemRow(
                  item: item,
